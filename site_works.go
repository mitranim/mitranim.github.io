...
func initWorks() []Work {
	return []Work{
		...
		},
		{
			...
			Lifecycle: Lifecycle{
				Start:  `2021`,
				Status: `used all the time; should be subsumed into "gg"`,
			},
		},
		{
			Name: `sublime-scss`,
		...
		},
		{
			...
			Role:      `author`,
			Tech:      `JS`,
			Lifecycle: Lifecycle{Start: `2021`, Status: `worse than Make`},
		},
		{
			Name: `try`,
		...
		},
		{
			...
			Role:      `author`,
			Tech:      `Go`,
			Lifecycle: Lifecycle{Start: `2021`, Status: `done`},
		},
		{
			Name:      `gtg`,
		...
		},
		{
			...
			Role:      `author`,
			Tech:      `Go`,
			Lifecycle: Lifecycle{Start: `2021`, Status: `done, actively used`},
		},
		{
			Name:      `frac`,
		...
		},
		{
			...
			Role:      `author`,
			Tech:      `Go`,
			Lifecycle: Lifecycle{Start: `2020`, Status: `done, actively used`},
		},
		{
			Name: `jel`,
		...
		},
		{
			...
			Role:      `author`,
			Tech:      `Go`,
			Lifecycle: Lifecycle{Start: `2020`, Status: `actively used`},
		},
		{
			Name: `sqlp`,
		...
		},
		{
			...
			Lifecycle: Lifecycle{
				Start:  `2017`,
				Status: `continuously used and updated`,
			},
		},
		{
			Name: `wordplay`,
			...
			Lifecycle: Lifecycle{
				Start:  `2017`,
				Status: `we invented more puns than some humans know WORDS`,
			},
		},
		{
			Name:      `epdf`,
		...
		},
		{
			...
			Role:      `author`,
			Tech:      `JS`,
			Lifecycle: Lifecycle{Start: `2017`, Status: `useful but paused`},
		},
		{
			Name:      `Bolala`,
		...
		},
		{
			...
			Role:      `author`,
			Tech:      `JS`,
			Lifecycle: Lifecycle{Start: `2015`, Status: `done`},
		},
		{
			Name:      `chat`,
		...
		},
		{
			...
			Role: `implementer`,
			Tech: `Python, Django, React; later: custom JS`,
			Lifecycle: Lifecycle{
				Start:  `2014`,
				Status: `frozen`,
				Link:   `https://github.com/mitranim/pp`,
