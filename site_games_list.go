	...
	out.AddUniq(Games{
		{
			...
			Link:     `https://store.steampowered.com/app/212680`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/212680/header.jpg`,
		...
		},
		{
			...
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/646570/header.jpg`,
			Desc:     `Strategic roguelike deck building dungeon crawler. Incredibly well designed and implemented. Founder of its own genre. One run ≈ 2-3 hours.`,
		...
		},
		{
			Id:       `beneath_oresa`,
			Name:     `Beneath Oresa`,
			Link:     `https://store.steampowered.com/app/1803400`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/1803400/header.jpg`,
			Desc:     `Strategic roguelike deck building dungeon crawler in beautiful 3D, set in distant future. One run ≈ 2-3 hours.`,
			TimeSink: TimeSinkModerate,
			Tags: Slice(
				TagPc, TagWindows,
		...
		},
		{
			Id:       `undertale`,
			Name:     `Undertale`,
			Link:     (`https://store.steampowered.com/app/391540`),
			Img:      (`https://cdn.cloudflare.steamstatic.com/steam/apps/391540/header.jpg`),
			Desc:     `Touching, uplifting story. _Highly_ recommended. Don't let the pixel art deter you from this experience.`,
			TimeSink: TimeSinkSafe,
			Tags: Slice(
		...
		},
		{
			Id:       `astroneer`,
			Name:     `Astroneer`,
			Link:     (`https://store.steampowered.com/app/361420`),
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/361420/header.jpg`,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/1151640`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/1151640/header.jpg`,
		...
		},
		{
			Id:       `subnautica`,
			Name:     `Subnautica`,
			Link:     `https://store.steampowered.com/app/264710`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/264710/header.jpg`,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/848450`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/848450/header.jpg`,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/435150`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/435150/header.jpg`,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/257510`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/257510/header.jpg`,
			...
			TimeSink: TimeSinkSafe,
			Tags: Slice(
				TagPc, TagWindows, TagMac, TagConsole,
		...
		{
			Id:       `talos_principle_2`,
			Name:     `Talos Principle 2`,
			Link:     `https://store.steampowered.com/app/835960`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/835960/header.jpg`,
			Desc:     `Perfectly ambitious sequel to TTP1. More puzzles, robots, and most of all, deep, thought-provoking discussions. Excellent transhumanist propaganda.`,
			TimeSink: TimeSinkSafe,
			Tags: Slice(
		...
		},
		{
			Id:       `portal`,
			Name:     `Portal`,
			Link:     `https://store.steampowered.com/app/400`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/400/header.jpg`,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/262060`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/262060/header.jpg`,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/1328670`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/1328670/header.jpg`,
			Desc:     `One of the greatest sci-fi RPG experiences ever made. Huge influence on other games and people's lives. Mechanics and graphics are outdated by modern standards, but the setting, characters, dialogues, story, music and more are timeless.`,
			TimeSink: TimeSinkDanger,
			Tags: Slice(
				TagPc, TagWindows, TagConsole,
				Tag3d, TagThirdPerson,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/1238000`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/1238000/header.jpg`,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/238010`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/238010/header.jpg`,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/337000`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/337000/header.jpg`,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/235460`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/235460/header.jpg`,
		...
		},
		{
			Id:       `nier_replicant`,
			Name:     `Nier Replicant`,
			Link:     `https://store.steampowered.com/app/1113560`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/1113560/header.jpg`,
			Desc:     `Transhumanist story carefully masquerading as fantasy JRPG. Play _before_ Nier Automata. For full effect, reach every ending (A B C D E) and _avoid spoilers_. Essential tools: [speedhacks](/posts/speed) for slog, [save editor](https://github.com/Acurisu/NieR-Replicant-ver.1.22474487139) for grind, also see [PCGW](https://www.pcgamingwiki.com/wiki/Nier_Replicant) for framerate.`,
			TimeSink: TimeSinkModerate,
			Tags: Slice(
				TagPc, TagConsole, TagWindows,
				Tag3d, TagThirdPerson, TagIsometric, TagTopdown, TagSideway,
				TagSolo, TagPve,
				TagMelee, TagMagic, TagSciFi, TagFantasy, TagParty,
				TagOpenWorld, TagStory, TagPhilosophical,
			),
			IsListed: true,
		},
		{
			Id:       `nier_automata`,
			Name:     `Nier Automata`,
			Link:     `https://store.steampowered.com/app/524220`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/524220/header.jpg`,
			Desc:     `Post-apocalyptic story of androids and alien machine lifeforms. Thought-provoking and touching. Brought me to tears. _Avoid spoilers!_ Go for "true ending"! Use original Japanese voiceovers. Requires external tools, check [PCGW](https://www.pcgamingwiki.com/wiki/Nier_Automata). Read [side materials](https://theark.wiki/w/I_just_got_Ending_E) afterwards (also [[1]](https://theark.wiki/w/Farewell)).`,
			TimeSink: TimeSinkModerate,
			Tags: Slice(
				TagPc, TagWindows, TagConsole,
				Tag3d, TagThirdPerson, TagIsometric, TagTopdown, TagSideway,
				TagSolo, TagPve,
				TagMelee, TagShooter, TagSciFi,
				TagOpenWorld, TagStory, TagPhilosophical,
			),
			IsListed: true,
		},
		{
			Id:       `prey`,
			Name:     `Prey`,
			Link:     `https://store.steampowered.com/app/480490`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/480490/header.jpg`,
		...
		},
		{
			Id:       `control`,
			Name:     `Control`,
			Link:     `https://store.steampowered.com/app/870780`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/870780/header.jpg`,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/20920`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/20920/header.jpg`,
		...
		},
		{
			...
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/230410/header.jpg`,
		...
		},
		{
			Id:       `no_mans_sky`,
			Name:     `No Man's Sky`,
			Link:     `https://store.steampowered.com/app/275850`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/275850/header.jpg`,
			Desc:     `Exploring an open-world galaxy where everything is procedurally generated. Lots of features. Requires x3 [speedhacks](/posts/speed). Consider [save editor](https://github.com/zencq/NomNom) to minimize grinding.`,
			TimeSink: TimeSinkDanger,
			Tags: Slice(
				TagPc, TagConsole, TagWindows,
				Tag3d, TagFirstPerson, TagThirdPerson,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/32370`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/32370/header.jpg`,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/208580`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/208580/header.jpg`,
		...
		},
		{
			Id:       `steins_gate`,
			Name:     `Steins Gate`,
			Link:     `https://store.steampowered.com/app/412830`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/412830/header.jpg`,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/280`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/280/header.jpg`,
			TimeSink: TimeSinkModerate,
			Tags: Slice(
				TagPc, TagWindows,
				Tag3d, TagFirstPerson,
		...
		},
		{
			Id:       `half_life_2`,
			Name:     `Half-Life 2`,
			Link:     `https://store.steampowered.com/app/220`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/220/header.jpg`,
			Desc:     `Influential first-person shooter with fluid on-the-fly story narration. Somewhat simplistic by modern standards, but still recommended, especially if you plan to play _Portal_.`,
			TimeSink: TimeSinkSafe,
			Tags: Slice(
				TagPc, TagWindows,
				Tag3d, TagFirstPerson,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/380`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/380/header.jpg`,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/420`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/420/header.jpg`,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/1172380`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/1172380/header.jpg`,
		...
		},
		{
			Id:       `singularity`,
			Name:     `Singularity`,
			Link:     `https://store.steampowered.com/app/42670`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/42670/header.jpg`,
		...
		},
		{
			Id:       `borderlands`,
			Name:     `Borderlands`,
			Link:     `https://store.steampowered.com/app/729040`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/729040/header.jpg`,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/261640`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/261640/header.jpg`,
		...
		},
		{
			Id:       `borderlands_2`,
			Name:     `Borderlands 2`,
			Link:     `https://store.steampowered.com/app/49520`,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/330830`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/330830/header.jpg`,
			Desc:     `Interactive story set on Pandora after _Borderlands 2_, featuring new protagonists. If you loved previous Borderlands games, this is worth a playthrough.`,
			TimeSink: TimeSinkSafe,
			Tags: Slice(
				TagPc, TagConsole, TagWindows, TagMac,
				Tag3d, TagThirdPerson,
		...
		},
		{
			Id:       `doom_2016`,
			Name:     `Doom (2016)`,
			Link:     `https://store.steampowered.com/app/379720`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/379720/header.jpg`,
		...
		},
		{
			...
			Link:     `https://store.steampowered.com/app/704450`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/704450/header.jpg`,
			Desc:     `Classic RPG using D&D 3.5 rules in pseudo real time. Don't be deterred by the boring OG campaign; expansions get better, and there's fun in the mechanics. Use console commands to unslog.`,
			TimeSink: TimeSinkModerate,
			Tags: Slice(
				TagPc, TagWindows,
		...
		},
		{
			Id:       `bastion`,
			Name:     `Bastion`,
			Link:     `https://store.steampowered.com/app/107100`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/107100/header.jpg`,
		...
		},
		{
			Id:       `darksiders`,
			Name:     `Darksiders`,
			Link:     `https://store.steampowered.com/app/462780`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/462780/header.jpg`,
		...
		},
		{
			Id:       `darksiders_2`,
			Name:     `Darksiders 2`,
			Link:     `https://store.steampowered.com/app/388410`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/388410/header.jpg`,
		...
		},
		{
			Id:       `darksiders_3`,
			Name:     `Darksiders 3`,
			Link:     `https://store.steampowered.com/app/606280`,
			Img:      `https://cdn.cloudflare.steamstatic.com/steam/apps/606280/header.jpg`,
		...
		},
		{
			...
			Desc:     `Masterpiece roguelike. Excellent game design and implementation, writing and voicing, music, sounds, UI, and more. Gamepad recommended, with macros. Read my [tips & tricks](/posts/hades)!`,
			TimeSink: TimeSinkModerate,
			Tags: Slice(
				TagPc, TagConsole, TagWindows, TagMac,
				Tag2d, TagIsometric,
