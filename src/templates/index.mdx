...
description: "about me: works, blog, demos"
---
...
Always up-to-date link to <a href="/resume" target="_blank">resume</a>. (Most browsers let you print to PDF.)

## Contacts

{{$.faSvg('skype')}} <span>skype [mitranim.web](skype:mitranim.web?chat)</span>

{{$.faSvg('mobile-alt')}} <span>phone +7-926-044-00-49</span>

<span>@ email [me@mitranim.com](mailto:me@mitranim.com)</span>

{{$.faSvg('paper-plane', {prefix: 'far'})}} <span>telegram [Mitranim](https://telegram.me/Mitranim)</span>

## Links

<a href="https://github.com/Mitranim" target="_blank">{{$.faSvg('github')}} Me on GitHub</a>

<a href="http://twitter.com/mitranim" target="_blank">{{$.faSvg('twitter')}} Me on Twitter</a>

<a href="http://linkedin.com/in/mitranim" target="_blank">{{$.faSvg('linkedin')}} Me on LinkedIn</a>

<a href="http://facebook.com/mitranim" target="_blank">{{$.faSvg('facebook')}} Me on Facebook</a>
