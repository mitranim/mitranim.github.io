...
title: works
description: software I helped write
---
...
### [Clojure/Datomic Starter](https://github.com/Mitranim/clojure-datomic-auth0-docker-starter) <span class="fg-faded">(Clojure / devops)</span>
